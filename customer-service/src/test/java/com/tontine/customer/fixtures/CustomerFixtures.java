...
public class CustomerFixtures {
    ...
    public static ApiCustomerRequest apiCustomerRequest1() {
        return new ApiCustomerRequest()
                ...
                .positions(List.of(ApiPosition.MEMBER))
    ...
    public static Customer customer1() {
        return Customer.builder()
                ...
                .positions(Set.of(Position.MEMBER))
    ...
    public static ApiCustomerRequest apiCustomerRequest2() {
        return new ApiCustomerRequest()
                ...
                .phone("+1987654321")
                .maritalStatus(ApiMaritalStatus.SINGLE)
                .positions(List.of(ApiPosition.MEMBER, ApiPosition.TREASURER))
                .address(new ApiAddress()
                        .street("456 Elm St")
                        .city("Othertown")
                        .state("Otherstate")
    ...
    public static Customer customer2() {
        return Customer.builder()
                ...
                .phone("+1987654321")
                .maritalStatus(MaritalStatus.SINGLE)
                .positions(Set.of(Position.MEMBER, Position.TREASURER))
                .address(Address.builder()
                        .street("456 Elm St")
                        .city("Othertown")
                        .state("Otherstate")
